...
CREATE TABLE IF NOT EXISTS checklists (
  ...
  send_time   TINYINT UNSIGNED NOT NULL DEFAULT 9 COMMENT 'Hora do dia para envio (0-23)',
...
CREATE TABLE IF NOT EXISTS checklist_daily_polls (
  ...
  waha_poll_id        VARCHAR(255)     DEFAULT NULL COMMENT 'ID retornado pelo WAHA (ex: false_{chatId}_{messageId})',
  selected_options    JSON             DEFAULT NULL COMMENT 'Array de strings com as opções selecionadas',
  completed_count     TINYINT UNSIGNED DEFAULT 0,
  total_count         TINYINT UNSIGNED DEFAULT 0,
  completion_pct      DECIMAL(5,2)     DEFAULT 0.00,
  last_vote_timestamp BIGINT           DEFAULT NULL COMMENT 'Timestamp do último voto para resolução de concorrência',
